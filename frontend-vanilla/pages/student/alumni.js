...
export async function renderStudentAlumni() {
    const app = document.getElementById('app');
    
    app.innerHTML = `
        <div class="container">
            <h1 style="margin-bottom: 2rem;">Alumni Directory</h1>
            <div class="card">
...
async function loadResults() {
    ...
    try {
        const data = await window.api.student.getAlumni(params);
